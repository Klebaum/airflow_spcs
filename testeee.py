...
with DAG(
    dag_id="teste_dag",default_args=DEFAULT_ARGS,
    tags=["spcs-demo"],
    schedule="@once",
    catchup=False,
) as dag:
    ...
    run_business_process_model = SPCSJobOperator(
                            ...
                            image= '/airflow_db/airflow_schema/airflow_repository/dbt_yugioh:latest', 
                            bash_command = "dbt run --profiles-dir dbt_yugioh/profiles",
